...
import com.example.townhall.databinding.ActivityAddUpdateDishBinding
import com.example.townhall.databinding.DialogCustomImageSelectionBinding
...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO : Assign the click event to the Add Dish button.
        // START
        ...
        mBinding.btnAddDish.setOnClickListener {
            val intent = Intent(this, GlideDemo::class.java)
    ...
    override fun onClick(v: View) {
        ...
        when (v.id) {
            ...
            // TODO : Perform the action on button click.
            // START
            R.id.btn_add_dish -> {
        ...
        binding.tvGallery.setOnClickListener {
            Dexter.withContext(this).withPermission(
                ...
                override fun onPermissionDenied(p0: PermissionDeniedResponse?) {
                    Toast.makeText(this@AddUpdateDishActivity, "You have denied the storage permission to select image.", Toast.LENGTH_SHORT).show()
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == CAMERA) {
                data?.extras?.let {
                    ...
                    // TODO Save the captured image via Camera to the app directory and get back the image path.
                    // START
                    mImagePath = saveImageToInternalStorage(thumbnail)
                    Log.i("ImagePath", mImagePath)
                    // END

                    mBinding.ivAddImage.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_vector_edit))
                }
            }
            if (requestCode == GALLERY) {
                data?.let {
                    ...
                    // TODO Implement the listener to get the bitmap of Image using Glide.
                    // START
        ...
        private fun showRationalDialogForPermissions() {
            AlertDialog.Builder(this).setMessage("It looks like you have turned off permissions. It can be enabled under Application Settings")
        ...
        /**
         * A function to save a copy of an image to internal storage for TownHall to use.
         *
         * @param bitmap
         */
    ...
    // TODO: Create a function to launch the Custom List dialog and pass the required params in it.
    // START
    /**
    ...
    // TODO: Create a function to set the selected item to the view.
    /**
    ...
    // END
        ...
        companion object {
            ...
            private const val IMAGE_DIRECTORY = "TownHallImages"
        }
}
