...
class TownHallAdapter (private val fragment: Fragment):RecyclerView.Adapter<TownHallAdapter.ViewHolder>() {
    ...
    private var dishes: List<TownHall> = listOf()
    ...
    // TODO : Create a function that will have the updated list of dishes that we will bind it to the adapter class.
    // START
    fun dishesList(list: List<TownHall>) {
        dishes = list
